import { Body, Controller, Get, HttpCode, HttpStatus, Post, Patch, Delete, Param } from '@nestjs/common';
...
export class TodoController {
  ...
  @Patch()
  @HttpCode(HttpStatus.OK)
  async updateIsFinished(@GetCurrentUser() user: User, @Body() body: UpdateIsFinishedDTO) {
  ...
  @Delete(':todoId')
  @HttpCode(HttpStatus.OK)
  async deleteTodo(@GetCurrentUser() user: User, @Param('todoId') todoId: string) {
