import { Controller, Get, HttpCode, HttpStatus, Patch, Body, UseInterceptors, UploadedFile, ParseFilePipe, MaxFileSizeValidator } from '@nestjs/common';
...
export class UserController {
  ...
  @HttpCode(HttpStatus.OK)
  async updateProfile(@GetCurrentUser() user: User, @UploadedFile(
    new ParseFilePipe({
      validators: [
        new MaxFileSizeValidator({ maxSize: 5000000 })
      ]
    })
  ) file: Express.Multer.File, @Body() body: UpdateProfileDTO) {
